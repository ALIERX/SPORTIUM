...
import { Home, Trophy, Brain, MoreHorizontal, User, Target, Sparkles, Users, Swords, Video, UserPlus, Crown, Zap, Award, Gift, Volume2, TrendingUp } from "lucide-react";
        ...
        <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
          ...
          <SheetContent side="bottom" className="bg-[#111318] border-t border-white/10 max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              ...
              {/* Other */}
              <div className="space-y-2">
                <div className="text-xs text-[#A9AFBC] px-3 mb-3">ALTRO</div>
                <div className="grid grid-cols-2 gap-2">
                  {moreTabs.other.map((tab) => {
                    const Icon = tab.icon;
                    const isActive = currentTab === tab.id;
                    return (
                      <button
