import { Home, Trophy, Brain, Award, User, Wallet, Gift, Volume2, Target, Sparkles, Users, Swords, Video, UserPlus, Crown, Zap, TrendingUp } from "lucide-react";
  ...
  return (
    <nav className="hidden md:flex fixed left-0 top-0 bottom-0 w-64 bg-[#111318] border-r border-white/10 flex-col z-50">
      ...
      <div className="flex-1 p-4 space-y-6 overflow-y-auto">
        ...
        {/* Other */}
        <div className="space-y-1">
          <div className="text-xs text-[#A9AFBC] px-3 mb-2">ALTRO</div>
          {otherTabs.map((tab) => {
            const Icon = tab.icon;
            const isActive = currentTab === tab.id;
            return (
